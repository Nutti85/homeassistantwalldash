...
const entities = {
  ...
  carAndreasTargetBattery: process.env.HA_CAR_ANDREAS_TARGET_BATTERY_ENTITY_ID?.trim() || defaultDashboardEntityIds.carAndreasTargetBattery,
  carAndreasChargingPower: process.env.HA_CAR_ANDREAS_CHARGING_POWER_ENTITY_ID?.trim() || defaultDashboardEntityIds.carAndreasChargingPower,
  carAndreasChargingStatus: process.env.HA_CAR_ANDREAS_CHARGING_STATUS_ENTITY_ID?.trim() || defaultDashboardEntityIds.carAndreasChargingStatus,
  carAndreasDeparture: process.env.HA_CAR_ANDREAS_DEPARTURE_ENTITY_ID?.trim() || defaultDashboardEntityIds.carAndreasDeparture,
  ...
  chargerMode: process.env.HA_CHARGER_MODE_ENTITY_ID?.trim() || defaultDashboardEntityIds.chargerMode,
  chargerPower: process.env.HA_CHARGER_POWER_ENTITY_ID?.trim() || defaultDashboardEntityIds.chargerPower,
  chargerPlug: process.env.HA_CHARGER_PLUG_ENTITY_ID?.trim() || defaultDashboardEntityIds.chargerPlug,
  chargerCharging: process.env.HA_CHARGER_CHARGING_ENTITY_ID?.trim() || defaultDashboardEntityIds.chargerCharging,
  chargerConnectivity: process.env.HA_CHARGER_CONNECTIVITY_ENTITY_ID?.trim() || defaultDashboardEntityIds.chargerConnectivity,
  ...
  workdayToday: process.env.HA_WORKDAY_TODAY_ENTITY_ID?.trim() || defaultDashboardEntityIds.workdayToday,
  workdayTomorrow: process.env.HA_WORKDAY_TOMORROW_ENTITY_ID?.trim() || defaultDashboardEntityIds.workdayTomorrow,
};
