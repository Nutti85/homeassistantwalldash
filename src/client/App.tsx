...
import { WeatherChart, WeatherGlyph, WeatherOverview, smoothPath } from './WeatherOverview';
import './roomCards.css';
import {
  calendarDayKey, calendarEventOccursOnDay, calendarEvents, currentTemperatureNumber, formatCalendarTime, forecastPoints, isRepairNeeded, jacobWeeklyPlan, meteoAlarmEntries, meteoEventMeta, mykidKindergarten, securityPresentation, stateValue, wasteDaysUntil,
...
const activityRefreshIntervalMs = 30_000;
